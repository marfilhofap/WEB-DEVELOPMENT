                ...
                <tbody>
                    <?php foreach ($dados as $a) : ?>
                        <tr>
                            ...
                            <td><?= $a['emis'] ?></td>
                            <td><a class="btn btn-warning" href="materia.php?edit_dados=<?= $a['id_utilijador'] ?>">edit</a>
                                <a class="btn btn-danger" href="materia.php?delete_dados=<?= $a['id_utilijador'] ?>">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
