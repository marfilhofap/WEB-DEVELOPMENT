...
{
    global $kon;
    $sql = "UPDATE t_estudante SET naran_estudante='$naran_estudante', sexo='$sexo', 
    data_moris='$data_moris' WHERE id_estudante='$id'";
...
{
    global $kon;
    $sql = "UPDATE t_materia SET materia = '$materia' WHERE id_materia = '$id_materia'";
    $dados = $kon->prepare($sql);
    $dados->execute();
}
